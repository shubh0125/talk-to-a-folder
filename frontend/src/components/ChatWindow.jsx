...
export default function ChatWindow({ messages, onSend, loading, onNewChat }) {
        ...
        <form onSubmit={handleSubmit} className="flex gap-2 items-end">
          {messages.length > 0 && (
            <button
              ...
              disabled={loading}
              title="New chat"
              className="text-[#55556a] hover:text-[#9090aa] disabled:opacity-40 disabled:cursor-not-allowed transition-colors shrink-0 p-3"
            >
